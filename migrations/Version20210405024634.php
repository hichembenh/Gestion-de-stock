 ...
 */
final class Version20210405024634 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_caract CHANGE article_id article_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article_caract CHANGE article_id article_id INT NOT NULL');
